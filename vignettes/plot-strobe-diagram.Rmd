...
# Create figures directory relative to current working directory
fig_dir <- "figures"
if (!dir.exists(fig_dir)) {
  dir.create(fig_dir, recursive = TRUE)
}

# Helper function to create figure paths
...
fig_path <- create_fig_path("strobe-diagram_vignette2_1.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_2a.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_2b.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_3.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_4.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_5a.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_5b.svg")
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_6.svg")
...
fig_path <- create_fig_path("strobe-diagram_vignette2_7.svg")
svg_file_2_7 <- plot_strobe_diagram(export_file = fig_path, 
...
```{r, out.width="50%", fig.align="center"}
fig_path <- create_fig_path("strobe-diagram_vignette2_8.svg")
