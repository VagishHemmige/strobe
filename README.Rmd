...
Finally, we plot the STROBE diagram associated with the above code.  Interactively, the `plot_strobe_diagram()` function can also directly create plots that can be viewed in the Rstudio viewer, but direct visualization in an .rmd file which has been knitted may cause formatting issues.

```{r strobe-plot, eval = requireNamespace("medicaldata", quietly = TRUE), message = FALSE, warning = FALSE}
