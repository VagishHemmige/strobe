...
We can use the `incl_height` option to set the height of the inclusion boxes, and the `excl_height` box to set the minimum width of the exclusion boxes.  
...
The `plot_strobe_diagram`'s underlying dependence means that the suggested widths and heights may not be 
